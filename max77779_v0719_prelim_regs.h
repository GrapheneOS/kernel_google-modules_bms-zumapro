 ...
 * source Sequoia_RegMap_customer_0719.xml
 * 2023-07-20
 */

#ifndef SEQUOIA_REGMAP_CUSTOMER_0719_REG_H_
#define SEQUOIA_REGMAP_CUSTOMER_0719_REG_H_
...
/*
 * MAX77779_PMIC_SPMI_CNFG,0x41,0b00011101,0x1d,OTP:SHADOW, Reset_Type:O
...
/*
 * MAX77779_FG_FW_REV,0x02,0b00000001,0x1,Reset_Type:S
 */
#define MAX77779_FG_FW_REV	0x62

/*
 * MAX77779_FG_FW_SUB_REV,0x03,0b00010001,0x11,Reset_Type:S
 */
...
/*
 * MAX77779_SGPIO_PD,0x02,0b01011110,0x5e,OTP:SHADOW, Reset_Type:O
...
/*
 * MAX77779_SGPIO_CNFG1,0x06,0b00000100,0x4,OTP:SHADOW, Reset_Type:O
 * DATA,VGPI_EN,MODE[2:2],DBNC_SEL[4:2],IRQ_SEL[6:2]
 */
...
/*
 * MAX77779_SGPIO_CNFG2,0x07,0b00000100,0x4,OTP:SHADOW, Reset_Type:O
 * DATA,VGPI_EN,MODE[2:2],DBNC_SEL[4:2],IRQ_SEL[6:2]
 */
...
/*
 * MAX77779_FG_TAlrtTh,0x04,0b00000000,0x0,Reset_Type:S
 * TMIN[0:8],TMAX[8:8]
 */
...
/*
 * MAX77779_FG_FullSocThr,0x13,0b00000000,0x0,Reset_Type:S
 */
...
/*
 * MAX77779_FG_SOCHold,0x3A,0b1000000000010,0x1002,Reset_Type:S
...
/*
 * MAX77779_FG_NVM_nModelCfg,0x9E,0b1000010000000000,0x8400,Reset_Type:S
 */
#define MAX77779_FG_NVM_nModelCfg	0x9e

/*
 * MAX77779_FG_NVM_nLearnCfg,0x9F,0b00000000,0x0,Reset_Type:S
 * Reserved_3_0[0:4],LearnStage[4:3]
 */
#define MAX77779_FG_NVM_nLearnCfg	0x9f
#define MAX77779_FG_NVM_nLearnCfg_Reserved_3_0_SHIFT	0
#define MAX77779_FG_NVM_nLearnCfg_Reserved_3_0_MASK	(0xf << 0)
#define MAX77779_FG_NVM_nLearnCfg_Reserved_3_0_CLEAR	(~(0xf << 0))
...
max77779_fg_nvm_nlearncfg_cstr(char *buff, size_t len, int val)
{
	...
	i += scnprintf(&buff[i], len - i, " Reserved_3_0=%x",
		FIELD2VALUE(MAX77779_Reserved_3_0, val));
	i += scnprintf(&buff[i], len - i, " LearnStage=%x",
		FIELD2VALUE(MAX77779_LearnStage, val));
#else
	buff[0] = 0;
...
MAX77779_BFF(max77779_fg_nvm_nlearncfg_reserved_3_0,3,0)
...
/*
 * MAX77779_FG_NVM_nFullSOCThr,0xBC,0b00000000,0x0,Reset_Type:S
 */
...
#endif /* SEQUOIA_REGMAP_CUSTOMER_0719_REG_H_ */
