...
/*
 * MAX77779_OTP_REVISION,0x02,0b00000000,0x0,OTP:SHADOW, Reset_Type:O
 */
#define MAX77779_OTP_REVISION	0x02

/*
 * MAX77779_INTSRC_STS,0x22,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_VDROOP_INT,0x23,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_INTB_MASK,0x24,0b11111111,0xff,OTP:SHADOW, Reset_Type:S
...
#define MAX77779_INTB_MASK_VDROOP_INT_M_SHIFT	6
#define MAX77779_INTB_MASK_VDROOP_INT_M_MASK	(0x1 << 6)
#define MAX77779_INTB_MASK_VDROOP_INT_M_CLEAR	(~(0x1 << 6))
...
MAX77779_BFF(max77779_intb_mask_vdroop_int_m,6,6)
MAX77779_BFF(max77779_intb_mask_pmictop_int_m,7,7)

/*
 * MAX77779_SPMI_INT_MASK,0x25,0b11111111,0xff,Reset_Type:S
...
/*
 * MAX77779_SPMI_INT_PRIORITY,0x26,0b00000001,0x1,Reset_Type:S
...
/*
 * MAX77779_VDROOP_INT_MASK,0x27,0b11111111,0xff,OTP:SHADOW, Reset_Type:O
...
/*
 * MAX77779_VDROOP_INT_SPMI_MASK,0x28,0b11111111,0xff,Reset_Type:O
...
/*
 * MAX77779_VDROOP_INT_SPMI_PRIORITY,0x29,0b00000001,0x1,Reset_Type:O
...
/*
 * MAX77779_PMICTOP_INT_STS,0x2A,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_PMICTOP_INT_MASK,0x2B,0b11111111,0xff,OTP:SHADOW, Reset_Type:S
...
/*
 * MAX77779_EVENT_CNT_CFG,0x30,0b00000000,0x0,OTP:SHADOW, Reset_Type:O
...
/*
 * MAX77779_EVENT_CNT_OILO0_THR,0x31,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_OILO0_THR	0x31

/*
 * MAX77779_EVENT_CNT_OILO1_THR,0x32,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_OILO1_THR	0x32

/*
 * MAX77779_EVENT_CNT_UVLO0_THR,0x33,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_UVLO0_THR	0x33

/*
 * MAX77779_EVENT_CNT_UVLO1_THR,0x34,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_UVLO1_THR	0x34

/*
 * MAX77779_EVENT_CNT_OILO0,0x35,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_OILO0	0x35

/*
 * MAX77779_EVENT_CNT_OILO1,0x36,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_OILO1	0x36

/*
 * MAX77779_EVENT_CNT_UVLO0,0x37,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_UVLO0	0x37

/*
 * MAX77779_EVENT_CNT_UVLO1,0x38,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_EVENT_CNT_UVLO1	0x38

/*
 * MAX77779_I2C_CNFG,0x40,0b00000000,0x0,Reset_Type:O
...
/*
 * MAX77779_SPMI_CNFG,0x41,0b00001110,0xe,OTP:SHADOW, Reset_Type:O
...
#define MAX77779_SPMI_CNFG_SDA_PULLDOWN_SHIFT	2
#define MAX77779_SPMI_CNFG_SDA_PULLDOWN_MASK	(0x1 << 2)
#define MAX77779_SPMI_CNFG_SDA_PULLDOWN_CLEAR	(~(0x1 << 2))
#define MAX77779_SPMI_CNFG_SCL_PULLDOWN_SHIFT	3
#define MAX77779_SPMI_CNFG_SCL_PULLDOWN_MASK	(0x1 << 3)
#define MAX77779_SPMI_CNFG_SCL_PULLDOWN_CLEAR	(~(0x1 << 3))
...
MAX77779_BFF(max77779_spmi_cnfg_sda_pulldown,2,2)
MAX77779_BFF(max77779_spmi_cnfg_scl_pulldown,3,3)
MAX77779_BFF(max77779_spmi_cnfg_vio_high,4,4)
MAX77779_BFF(max77779_spmi_cnfg_spr_7_5,7,5)

/*
 * MAX77779_SPMI_MID,0x42,0b00010110,0x16,Reset_Type:O
...
#define MAX77779_SPMI_MID_SPMI_MW_ENABLE_SHIFT	2
#define MAX77779_SPMI_MID_SPMI_MW_ENABLE_MASK	(0x1 << 2)
#define MAX77779_SPMI_MID_SPMI_MW_ENABLE_CLEAR	(~(0x1 << 2))
#define MAX77779_SPMI_MID_SPR_3_SHIFT	3
#define MAX77779_SPMI_MID_SPR_3_MASK	(0x1 << 3)
#define MAX77779_SPMI_MID_SPR_3_CLEAR	(~(0x1 << 3))
#define MAX77779_SPMI_MID_SPMI_ARB_MODE_SHIFT	4
#define MAX77779_SPMI_MID_SPMI_ARB_MODE_MASK	(0x1 << 4)
#define MAX77779_SPMI_MID_SPMI_ARB_MODE_CLEAR	(~(0x1 << 4))
#define MAX77779_SPMI_MID_SPR_6_5_SHIFT	5
#define MAX77779_SPMI_MID_SPR_6_5_MASK	(0x3 << 5)
#define MAX77779_SPMI_MID_SPR_6_5_CLEAR	(~(0x3 << 5))
...
MAX77779_BFF(max77779_spmi_mid_spmi_mw_enable,2,2)
MAX77779_BFF(max77779_spmi_mid_spr_3,3,3)
MAX77779_BFF(max77779_spmi_mid_spmi_arb_mode,4,4)
MAX77779_BFF(max77779_spmi_mid_spr_6_5,6,5)
MAX77779_BFF(max77779_spmi_mid_spmi_msg_repeat,7,7)

/*
 * MAX77779_SPMI_MADDR,0x43,0b00000000,0x0,Reset_Type:O
 */
#define MAX77779_SPMI_MADDR	0x43

/*
 * MAX77779_SPMI_STS,0x44,0b00000000,0x0,Reset_Type:O
...
#define MAX77779_SPMI_STS_RSVD_6_1_SHIFT	1
#define MAX77779_SPMI_STS_RSVD_6_1_MASK	(0x3f << 1)
#define MAX77779_SPMI_STS_RSVD_6_1_CLEAR	(~(0x3f << 1))
static inline const char *
...
MAX77779_BFF(max77779_spmi_sts_rsvd_6_1,6,1)

/*
 * MAX77779_SWRESET,0x50,0b00000000,0x0,Reset_Type:S, (Exception: SWR_RST bits are not register type which can retain data)
...
/*
 * MAX77779_CONTROL_FG,0x51,0b00010000,0x10,Reset_Type:F
 * TSHDN_DIS
 */
...
/*
 * MAX77779_CHGCHGIN_I_ADC_L,0x00,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCHGIN_I_ADC_L	0x00

/*
 * MAX77779_CHGCHGIN_I_ADC_H,0x01,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCHGIN_I_ADC_H	0x01

/*
 * MAX77779_CHGCHGIN_V_ADC_L,0x02,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCHGIN_V_ADC_L	0x02

/*
 * MAX77779_CHGCHGIN_V_ADC_H,0x03,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCHGIN_V_ADC_H	0x03

/*
 * MAX77779_CHGWCIN_I_ADC_L,0x04,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGWCIN_I_ADC_L	0x04

/*
 * MAX77779_CHGWCIN_I_ADC_H,0x05,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGWCIN_I_ADC_H	0x05

/*
 * MAX77779_CHGWCIN_V_ADC_L,0x06,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGWCIN_V_ADC_L	0x06

/*
 * MAX77779_CHGWCIN_V_ADC_H,0x07,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGWCIN_V_ADC_H	0x07

/*
 * MAX77779_CHGTHM1_TEMP_L,0x08,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM1_TEMP_L	0x08

/*
 * MAX77779_CHGTHM1_TEMP_H,0x09,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM1_TEMP_H	0x09

/*
 * MAX77779_CHGTHM2_TEMP_L,0x0A,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM2_TEMP_L	0x0a

/*
 * MAX77779_CHGTHM2_TEMP_H,0x0B,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM2_TEMP_H	0x0b

/*
 * MAX77779_CHGTHM3_TEMP_L,0x0C,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM3_TEMP_L	0x0c

/*
 * MAX77779_CHGTHM3_TEMP_H,0x0D,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGTHM3_TEMP_H	0x0d

/*
 * MAX77779_CHGBATT_ID1_ADC_L,0x0E,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGBATT_ID1_ADC_L	0x0e

/*
 * MAX77779_CHGBATT_ID1_ADC_H,0x0F,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGBATT_ID1_ADC_H	0x0f

/*
 * MAX77779_CHGBATT_ID2_ADC_L,0x10,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGBATT_ID2_ADC_L	0x10

/*
 * MAX77779_CHGBATT_ID2_ADC_H,0x11,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGBATT_ID2_ADC_H	0x11

/*
 * MAX77779_CHGJEITA_CTRL,0x12,0b00000000,0x0,OTP:SHADOW, Reset_Type:O
...
/*
 * MAX77779_CHGJEITA_FLAGS,0x13,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_CHGCOP_CTRL,0x20,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_CHGCOP_DEBOUNCE,0x21,0b00000000,0x0,Reset_Type:S
 * COP_DB_TIME[0:3]
 */
...
/*
 * MAX77779_CHGCOP_WARN_L,0x22,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCOP_WARN_L	0x22

/*
 * MAX77779_CHGCOP_WARN_H,0x23,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCOP_WARN_H	0x23

/*
 * MAX77779_CHGCOP_LIMIT_L,0x24,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_CHGCOP_LIMIT_L	0x24

/*
 * MAX77779_CHGCOP_LIMIT_H,0x25,0b00000000,0x0,Reset_Type:S
 */
...
/*
 * MAX77779_M5_FG_INT_STS,0x00,0b00000010,0x2,Reset_Type:F
...
/*
 * MAX77779_M5_Mask,0x01,0b00000010,0x2,Reset_Type:F
...
/*
 * MAX77779_BVIMBVIM_INT_STS,0x00,0b00000000,0x0,Reset_Type:F
 * BVIM_Samples_Rdy
 */
...
/*
 * MAX77779_BVIMBVIM_MASK,0x01,0b00000001,0x1,Reset_Type:F
 * BVIM_Samples_Rdy_m
 */
...
/*
 * MAX77779_BVIMBVIM_CTRL,0x10,0b00000000,0x0,Reset_Type:F
 * BVIMON_TRIG
 */
...
/*
 * MAX77779_BVIMbvim_cfg,0x00,0b00000000,0x0,Reset_Type:S
...
#define MAX77779_BVIMbvim_cfg_batoiolo1_stop_SHIFT	12
#define MAX77779_BVIMbvim_cfg_batoiolo1_stop_MASK	(0x1 << 12)
#define MAX77779_BVIMbvim_cfg_batoiolo1_stop_CLEAR	(~(0x1 << 12))
#define MAX77779_BVIMbvim_cfg_batoiolo2_stop_SHIFT	13
#define MAX77779_BVIMbvim_cfg_batoiolo2_stop_MASK	(0x1 << 13)
#define MAX77779_BVIMbvim_cfg_batoiolo2_stop_CLEAR	(~(0x1 << 13))
#define MAX77779_BVIMbvim_cfg_top_fault_stop_SHIFT	14
#define MAX77779_BVIMbvim_cfg_top_fault_stop_MASK	(0x1 << 14)
#define MAX77779_BVIMbvim_cfg_top_fault_stop_CLEAR	(~(0x1 << 14))
#define MAX77779_BVIMbvim_cfg_vioaok_stop_SHIFT	15
#define MAX77779_BVIMbvim_cfg_vioaok_stop_MASK	(0x1 << 15)
#define MAX77779_BVIMbvim_cfg_vioaok_stop_CLEAR	(~(0x1 << 15))
static inline const char *
...
MAX77779_BFF(max77779_bvimbvim_cfg_batoiolo1_stop,12,12)
MAX77779_BFF(max77779_bvimbvim_cfg_batoiolo2_stop,13,13)
MAX77779_BFF(max77779_bvimbvim_cfg_top_fault_stop,14,14)
MAX77779_BFF(max77779_bvimbvim_cfg_vioaok_stop,15,15)

/*
 * MAX77779_BVIMsmpl_math,0x01,0b00000000,0x0,Reset_Type:S
...
#define MAX77779_BVIMsmpl_math_SPR_6_3_SHIFT	3
#define MAX77779_BVIMsmpl_math_SPR_6_3_MASK	(0xf << 3)
#define MAX77779_BVIMsmpl_math_SPR_6_3_CLEAR	(~(0xf << 3))
...
MAX77779_BFF(max77779_bvimsmpl_math_spr_6_3,6,3)
MAX77779_BFF(max77779_bvimsmpl_math_smpl_start_add,15,7)

/*
 * MAX77779_BVIMbvim_trig,0x02,0b00000000,0x0,Reset_Type:S
...
#define MAX77779_BVIMbvim_trig_batoilo1_tr_SHIFT	1
#define MAX77779_BVIMbvim_trig_batoilo1_tr_MASK	(0x1 << 1)
#define MAX77779_BVIMbvim_trig_batoilo1_tr_CLEAR	(~(0x1 << 1))
#define MAX77779_BVIMbvim_trig_batoilo2_tr_SHIFT	2
#define MAX77779_BVIMbvim_trig_batoilo2_tr_MASK	(0x1 << 2)
#define MAX77779_BVIMbvim_trig_batoilo2_tr_CLEAR	(~(0x1 << 2))
#define MAX77779_BVIMbvim_trig_sysuvlo1_tr_SHIFT	3
#define MAX77779_BVIMbvim_trig_sysuvlo1_tr_MASK	(0x1 << 3)
#define MAX77779_BVIMbvim_trig_sysuvlo1_tr_CLEAR	(~(0x1 << 3))
#define MAX77779_BVIMbvim_trig_sysuvlo2_tr_SHIFT	4
#define MAX77779_BVIMbvim_trig_sysuvlo2_tr_MASK	(0x1 << 4)
#define MAX77779_BVIMbvim_trig_sysuvlo2_tr_CLEAR	(~(0x1 << 4))
#define MAX77779_BVIMbvim_trig_vbatt_tr_SHIFT	5
#define MAX77779_BVIMbvim_trig_vbatt_tr_MASK	(0x1 << 5)
#define MAX77779_BVIMbvim_trig_vbatt_tr_CLEAR	(~(0x1 << 5))
#define MAX77779_BVIMbvim_trig_ibatt_tr_SHIFT	6
#define MAX77779_BVIMbvim_trig_ibatt_tr_MASK	(0x1 << 6)
#define MAX77779_BVIMbvim_trig_ibatt_tr_CLEAR	(~(0x1 << 6))
#define MAX77779_BVIMbvim_trig_SPR_7_SHIFT	7
#define MAX77779_BVIMbvim_trig_SPR_7_MASK	(0x1 << 7)
#define MAX77779_BVIMbvim_trig_SPR_7_CLEAR	(~(0x1 << 7))
#define MAX77779_BVIMbvim_trig_vbatt_avg_tr_SHIFT	8
#define MAX77779_BVIMbvim_trig_vbatt_avg_tr_MASK	(0x1 << 8)
#define MAX77779_BVIMbvim_trig_vbatt_avg_tr_CLEAR	(~(0x1 << 8))
#define MAX77779_BVIMbvim_trig_vbatt_min_tr_SHIFT	9
#define MAX77779_BVIMbvim_trig_vbatt_min_tr_MASK	(0x1 << 9)
#define MAX77779_BVIMbvim_trig_vbatt_min_tr_CLEAR	(~(0x1 << 9))
#define MAX77779_BVIMbvim_trig_vbatt_max_tr_SHIFT	10
#define MAX77779_BVIMbvim_trig_vbatt_max_tr_MASK	(0x1 << 10)
#define MAX77779_BVIMbvim_trig_vbatt_max_tr_CLEAR	(~(0x1 << 10))
#define MAX77779_BVIMbvim_trig_ibatt_avg_tr_SHIFT	11
#define MAX77779_BVIMbvim_trig_ibatt_avg_tr_MASK	(0x1 << 11)
#define MAX77779_BVIMbvim_trig_ibatt_avg_tr_CLEAR	(~(0x1 << 11))
#define MAX77779_BVIMbvim_trig_ibatt_min_tr_SHIFT	12
#define MAX77779_BVIMbvim_trig_ibatt_min_tr_MASK	(0x1 << 12)
#define MAX77779_BVIMbvim_trig_ibatt_min_tr_CLEAR	(~(0x1 << 12))
#define MAX77779_BVIMbvim_trig_ibatt_max_tr_SHIFT	13
#define MAX77779_BVIMbvim_trig_ibatt_max_tr_MASK	(0x1 << 13)
#define MAX77779_BVIMbvim_trig_ibatt_max_tr_CLEAR	(~(0x1 << 13))
#define MAX77779_BVIMbvim_trig_oilo_start_source_SHIFT	14
#define MAX77779_BVIMbvim_trig_oilo_start_source_MASK	(0x1 << 14)
#define MAX77779_BVIMbvim_trig_oilo_start_source_CLEAR	(~(0x1 << 14))
#define MAX77779_BVIMbvim_trig_oilo_stop_source_SHIFT	15
#define MAX77779_BVIMbvim_trig_oilo_stop_source_MASK	(0x1 << 15)
#define MAX77779_BVIMbvim_trig_oilo_stop_source_CLEAR	(~(0x1 << 15))
static inline const char *
...
MAX77779_BFF(max77779_bvimbvim_trig_batoilo1_tr,1,1)
MAX77779_BFF(max77779_bvimbvim_trig_batoilo2_tr,2,2)
MAX77779_BFF(max77779_bvimbvim_trig_sysuvlo1_tr,3,3)
MAX77779_BFF(max77779_bvimbvim_trig_sysuvlo2_tr,4,4)
MAX77779_BFF(max77779_bvimbvim_trig_vbatt_tr,5,5)
MAX77779_BFF(max77779_bvimbvim_trig_ibatt_tr,6,6)
MAX77779_BFF(max77779_bvimbvim_trig_spr_7,7,7)
MAX77779_BFF(max77779_bvimbvim_trig_vbatt_avg_tr,8,8)
MAX77779_BFF(max77779_bvimbvim_trig_vbatt_min_tr,9,9)
MAX77779_BFF(max77779_bvimbvim_trig_vbatt_max_tr,10,10)
MAX77779_BFF(max77779_bvimbvim_trig_ibatt_avg_tr,11,11)
MAX77779_BFF(max77779_bvimbvim_trig_ibatt_min_tr,12,12)
MAX77779_BFF(max77779_bvimbvim_trig_ibatt_max_tr,13,13)
MAX77779_BFF(max77779_bvimbvim_trig_oilo_start_source,14,14)
MAX77779_BFF(max77779_bvimbvim_trig_oilo_stop_source,15,15)

/*
 * MAX77779_BVIMbvimtr,0x03,0b00000000,0x0,Reset_Type:S
...
/*
 * MAX77779_BVIMbvim_vtr_mth,0x04,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_vtr_mth	0x64

/*
 * MAX77779_BVIMbvim_itr_mth,0x05,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_itr_mth	0x65

/*
 * MAX77779_BVIMbvim_vtr_smin_th,0x06,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_vtr_smin_th	0x66

/*
 * MAX77779_BVIMbvim_vtr_smax_th,0x07,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_vtr_smax_th	0x67

/*
 * MAX77779_BVIMbvim_vtr_savg_th,0x08,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_vtr_savg_th	0x68

/*
 * MAX77779_BVIMbvim_itr_smin_th,0x09,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_itr_smin_th	0x69

/*
 * MAX77779_BVIMbvim_itr_smax_th,0x0A,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_itr_smax_th	0x6a

/*
 * MAX77779_BVIMbvim_itr_savg_th,0x0B,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_itr_savg_th	0x6b

/*
 * MAX77779_BVIMbvim_sts,0x0C,0b00000000,0x0,Reset_Type:S
...
#define MAX77779_BVIMbvim_sts_bvim_stopped_SHIFT	11
#define MAX77779_BVIMbvim_sts_bvim_stopped_MASK	(0x1 << 11)
#define MAX77779_BVIMbvim_sts_bvim_stopped_CLEAR	(~(0x1 << 11))
#define MAX77779_BVIMbvim_sts_stop_sts_oilo1_SHIFT	12
#define MAX77779_BVIMbvim_sts_stop_sts_oilo1_MASK	(0x1 << 12)
#define MAX77779_BVIMbvim_sts_stop_sts_oilo1_CLEAR	(~(0x1 << 12))
#define MAX77779_BVIMbvim_sts_stop_sts_oilo2_SHIFT	13
#define MAX77779_BVIMbvim_sts_stop_sts_oilo2_MASK	(0x1 << 13)
#define MAX77779_BVIMbvim_sts_stop_sts_oilo2_CLEAR	(~(0x1 << 13))
#define MAX77779_BVIMbvim_sts_stop_sts_fault_SHIFT	14
#define MAX77779_BVIMbvim_sts_stop_sts_fault_MASK	(0x1 << 14)
#define MAX77779_BVIMbvim_sts_stop_sts_fault_CLEAR	(~(0x1 << 14))
#define MAX77779_BVIMbvim_sts_stop_sts_vioaok_SHIFT	15
#define MAX77779_BVIMbvim_sts_stop_sts_vioaok_MASK	(0x1 << 15)
#define MAX77779_BVIMbvim_sts_stop_sts_vioaok_CLEAR	(~(0x1 << 15))
static inline const char *
...
MAX77779_BFF(max77779_bvimbvim_sts_bvim_stopped,11,11)
MAX77779_BFF(max77779_bvimbvim_sts_stop_sts_oilo1,12,12)
MAX77779_BFF(max77779_bvimbvim_sts_stop_sts_oilo2,13,13)
MAX77779_BFF(max77779_bvimbvim_sts_stop_sts_fault,14,14)
MAX77779_BFF(max77779_bvimbvim_sts_stop_sts_vioaok,15,15)

/*
 * MAX77779_BVIMbvim_rs,0x0D,0b00000000,0x0,Reset_Type:S
...
#define MAX77779_BVIMbvim_rs_SPR_15_13_SHIFT	13
#define MAX77779_BVIMbvim_rs_SPR_15_13_MASK	(0x7 << 13)
#define MAX77779_BVIMbvim_rs_SPR_15_13_CLEAR	(~(0x7 << 13))
static inline const char *
...
MAX77779_BFF(max77779_bvimbvim_rs_spr_15_13,15,13)

/*
 * MAX77779_BVIMbvim_rlap,0x0E,0b00000000,0x0,Reset_Type:S
 */
#define MAX77779_BVIMbvim_rlap	0x6e

/*
 * MAX77779_BVIMbvim_rfap,0x0F,0b00000000,0x0,Reset_Type:S
 */
...
/*
 * MAX77779_BVIMBVIM_PAGE_CTRL,0x00,0b00000000,0x0,Reset_Type:F
 * BVIM_DATA_PAGE[0:2]
 */
